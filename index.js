...
class Student extends Lambdasian {
  constructor({name, age, location, specialty, previousBackground, className, favSubjects}) {
    super({name, age, location, specialty, previousBackground, className, favSubjects});
